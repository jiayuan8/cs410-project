...
class SignatureOnlyEndpoint(BaseEndpoint):
    ...
    def validate_request(self, uri, http_method='GET',
        ...
        try:
            ...
            print("Exception caught while validating request",flush=True)
            log.info(
                'Exception caught while validating request, %s.' % err)
        ...
        if not self.request_validator.validate_timestamp_and_nonce(
            ...
            print("[Failure] verification failed: timestamp/nonce",flush=True)
        ...
        print("vcccc",valid_client,valid_signature,flush=True)
        return v, request
